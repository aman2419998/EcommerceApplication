...
const userUpdateDetailAction = (user) => async (dispatch, getState) => {
  try {
    dispatch({
...
const userDetailByAdminAction = (id) => async (dispatch, getState) => {
  try {
    dispatch({
...
const userUpdateByAdminAction = (id, name, email, isAdmin) => async (
  dispatch,
  getState
) => {
  try {
